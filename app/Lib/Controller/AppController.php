...
class AppController extends Controller {
	...
	public function beforeFilter() {
		...
		if(in_array($this->params['controller'],array('rest_produtos', 'rest_clientes', 'rest_pedidos', 'rest_atendimentos', 'rest_mensagens','rest_filials'))){
