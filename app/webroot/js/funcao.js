$(document).ready(function() {
	...
	$('body').on('click', '.viewpedido', function(event){
		...
		$('#modalLoaded').html(' ');
                    ...
                    urlview= 'http://'+urlInicio+'/Pedidos/view/'+idpedido+'/?loja='+loja+'&id='+idpedido;

		$("#loadModalPedido").load(urlview, function(){
	...
	$('body').on('click', '.viewvenda', function(event){
		event.preventDefault();
		...
		$('#modalLoaded').html(' ');
		loja = $('#filterMinhaslojas').val();
		urlview= 'http://'+urlInicio+'/Vendas/view/'+idpedido+'/?loja='+loja+'&id='+idpedido;

		$("#loadModalVenda").load(urlview, function(){
	...
	$('body').on('click', '.addvenda', function(event){
		...
		$('#modalLoaded').html(' ');
		$("#loadModalVenda").load('http://'+urlInicio+'/Vendas/add/?loja='+loja, function(){
			$('#modalNovoVenda').modal('show');
		});
	});
	...
	$('#fecharcancelarpedido').click(function(event){
		event.preventDefault();
	...
	function getCoordenadas() {
		...
		var url="http://maps.googleapis.com/maps/api/geocode/json?address="+pesquisa+"&sensor=true";
		 ...
		 $.ajax({
				...
				latorigin = $('.latOrigem').val();
				lngorigin =$('.lngOrigem').val();
