	  ...
	  <div class="modal-dialog">
	    <div class="modal-content">
	      <div class="modal-header">
	        ...
	        <h4 class="modal-title" id="myModalLabel"> Editar Atendente</h4>
	      </div>
	      <div class="modal-body">
				...
				<div >
					...
					<div class="status-atendente form-group  form-group-lg">
						<?php
