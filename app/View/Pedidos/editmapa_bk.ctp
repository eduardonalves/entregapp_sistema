    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
			<?php echo $this->Form->create('Pedido',array('class' => 'form-inline'));	?>
				...
				<?php echo $this->Form->input('modemapa',array('readonly' => 'readonly','type'=>'hidden','class' => 'input-large modeMapa','id'=>'modeMapa','label' => false));?>
				<?php echo $this->Form->input('dtini',array('readonly' => 'readonly','type'=>'hidden','class' => 'input-large dtini','id'=>'dtini','label' => false));?>
				<?php echo $this->Form->input('dtfim',array('readonly' => 'readonly','type'=>'hidden','class' => 'input-large dtfim','id'=>'dtfim','label' => false));?>
				<?php echo $this->Form->input('stausentrega',array('readonly' => 'readonly','type'=>'hidden','class' => 'input-large stausentrega','id'=>'stausentrega','label' => false));?>
				<?php echo $this->Form->input('entregador',array('readonly' => 'readonly','type'=>'hidden','class' => 'input-large entregador','id'=>'entregador','label' => false));?>
				<?php
				...
				<?php endif; ?>
				<?php echo $this->Form->input('modemapaedit',array('readonly' => 'readonly','type'=>'hidden','class' => 'input-large modeMapa','id'=>'modemapaedit','label' => false));?>
				<?php echo $this->Form->input('dtiniedit',array('readonly' => 'readonly','type'=>'hidden','class' => 'input-large dtini','id'=>'dtiniedit','label' => false));?>
				<?php echo $this->Form->input('dtfimedit',array('readonly' => 'readonly','type'=>'hidden','class' => 'input-large dtfim','id'=>'dtfimedit','label' => false));?>
				<?php echo $this->Form->input('stausentregaedit',array('readonly' => 'readonly','type'=>'hidden','class' => 'input-large stausentrega','id'=>'stausentregaedit','label' => false));?>
				<?php echo $this->Form->input('entregadoredit',array('readonly' => 'readonly','type'=>'hidden','class' => 'input-large entregadoredit','id'=>'entregadoredit','label' => false));?>
...
$(document).ready(function() {
	...
	$('#modemapaedit').val($('#selectmode').val());
	$('#dtiniedit').val($('#dtini').val());
	$('#dtfimedit').val($('#dtfim').val());
	$('#stausentregaedit').val($('#entrega').val());
	$('#entregadoredit').val($('#entregador').val());

	$('body').on('click','#bt-salvarEdit', function(event){
		event.preventDefault();
		$('#PedidoEditmapaForm').submit();
	});
