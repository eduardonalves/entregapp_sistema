<div class="modal fade show modal-editPedido" id="modalLoaded" aria-modal="true" style="padding-right: 19px; display: block;">
		...
		<div class="modal-content bg-dark">
			...
			<div class="modal-body">
				...
				<span class="modal-subtitulo">
					<h3>Pedido: <?php echo $pedido['Pedido']['id']; ?></h3>
				</span>
				...
				<?php if ($pedido['Pedido']['nomecadcliente'] == '' || $pedido['Pedido']['atendente_id'] != '') :  ?>
					...
					<p><span id="avaliarPedido"><?php //echo h($pedido['Pedido']['avaliacao']); 
												?></span></p>
				</div>-->
			...
			<div class="modal-footer justify-content-between">
				<button type="button" class="btn btn-info orange-st" id="cancelarPedidoModal">Cancelar Pedido</button>
				<button type="submit" class="btn btn-info orange-st" id="bt-salvarEdit">Salvar</button>
