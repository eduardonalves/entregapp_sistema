	  ...
	  <div class="modal-dialog">
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
				...
				<section class="row">
					<section class="span4 spancliente">
						<label>Cliente: </label>
						  <br>
					...
					<section class="span2 spanPagamento">
				...
				<!--	<section class="span2 spanAtendente">
						<label>Atendente: </label>

					<br>
							<select name="data[Pedido][atentente_id]" class="selectAtendente input-default" id="selectAtendente">
							<option value="0"></option>
								<?php
/*
									foreach ($atendentes as $atendente) {
										echo '<option value="'.$atendente['Atendente']['id'].'" >'.$atendente['Atendente']['nome'].'</option>';
									}
									*/
								?>
							 </select>
...
<!--  ############################################################################################################ -->
				...
				<section class="row" style="margin-top:10px;margin-bottom:30px;">
					...
					?>
					<section class="span3 spanEntregador">
