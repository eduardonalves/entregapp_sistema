	  ...
	  <div class="modal-dialog">
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	  		<div class="row-fluid">
				<div >
					<?php echo $this->Form->create('Setor',array('class' => 'form-inline centralizadoForm'));
						?>
					<div class="form-group  form-group-lg">
						<?php
						echo $this->Form->input('id');
						echo $this->Form->input('setor',array('default' => $seto['Setor']['setor'],'readonly' => 'readonly','class' => 'input-default','label' => array('text' => 'Setor:')));
						?>
					</div>
				</div>
			</div>
