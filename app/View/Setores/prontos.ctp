<div class="monitorar-container" ng-app="EntregApp">
	...
	<h2><?php echo __('Solicitações Prontas'); ?></h2>
		<!-- Modal -->
					...
					<table class="table-action col-md-12 table-bordered table-striped table-condensed cf" >
						...
						<tbody >
							...
							<tr ng-repeat="data in filtered = (list | filter:search | orderBy : predicate :reverse) | startFrom:(currentPage-1)*entryLimit | limitTo:entryLimit">
								...
								<td data-title="Coluna"> <button type="button" name="button" ng-init="id=data.Itensdepedido.id;" data-id="{{data.Itensdepedido.id}}" class="btn btn-success" ng-click="confirmar(data.Itensdepedido.id);">Entregue</button> </td>
							</tr>
