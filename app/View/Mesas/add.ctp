...
<h2><?php echo __('Cadastro de Mesa'); ?></h2>
	<!-- Modal -->
	  ...
	  <div class="modal-dialog">
	    <div class="modal-content">
	      <div class="modal-header">
	        ...
	        <h4 class="modal-title" id="myModalLabel"> Cadastrar Mesa</h4>
	      </div>
	      <div class="modal-body">
	  		<div class="row-fluid">
				<div >
					<?php echo $this->Form->create('Mesa',array('class' => 'form-inline centralizadoForm'));
						?>
					<div class="form-group  form-group-lg">
						<?php
						echo $this->Form->input('identificacao',array('class' => 'input-large','label' => array('text' => 'Mesa', 'class' => 'labellarge')));
						?>
					</div>
...
$('body').on('click','.editModal', function(event){
	...
	//	$('#divActions'+idpedido).hide();
		$("#loadDivModal").load('http://'+urlInicio+'/mesas/edit/'+modalid+'', function(){
