	  ...
	  <div class="modal-dialog">
	    <div class="modal-content">
	      <div class="modal-header">
	        ...
	        <h4 class="modal-title" id="myModalLabel">Entrega</h4>
	      </div>
	  		...
	  		<div class="row-fluid">
				<div >
					...
					<div class="form-group  form-group-lg">
						...
						echo $this->Form->input('identificacao',array('default' => $entrega['Entrega']['identificacao'],'readonly' => 'readonly','class' => 'input-default','label' => array('text' => 'Entrega:')));
						?>
					</div>
				</div>
			</div>
