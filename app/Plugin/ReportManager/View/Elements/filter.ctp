        ...
        <table class="reportManagerFilterSelector" cellpadding="0" cellspacing="0">
            <thead>
                <tr>
                    ...
                    <td><?php echo __('Campo'); ?></td>
                    <td class="reportManagerFilterNot"><?php echo __('Negação'); ?></td>
                    <td class="reportManagerFilterCriteria"><?php echo __('Critério'); ?></td>
                    <td class="reportManagerFilterExample"><?php echo __('Exemplo'); ?></td>
                </tr>
            </thead>
	<?php
        $filterOptions = array(          
